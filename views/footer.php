		<?php if((isset($prefootercontent) && $prefootercontent != "") || (isset($prefooterbuttontext) && $prefooterbuttontext != "")){ ?>
		<div id="prefooter">
			<div class="container">
				<div class="row-fluid">
					<div class="span7 tagline">
						<h3><?php echo $prefootercontent; ?></h3>
					</div>
					<div class="span5">
						<div class="button">
							<a href="<?php echo $prefooterbuttonurl; ?>" <?php if($prefooterbuttontext == 'Try our message calculator'){ echo "rel='cometcontent'"; } ?> style="max-width: <?php echo $prefooterbuttonsize; ?>px"><?php echo $prefooterbuttontext; ?></a>
						</div>
					</div>		
				</div>	
			</div>
			...
			<div class="container">
				<div class="row-fluid foot_sec2">
					<div class="span6 blogs">
						...
						<?php
							buildrss();
							echo file_get_contents(dirname(dirname(__FILE__)).'/cache/rss-'.CDN_VERSION.'.txt');
						?>
					</div>
					<div class="span1">
					</div>
					<div class="span5">
						...
						<div class="row-fluid">
							<div class="span12">
								<div  id="subscribe">
									<form action="<?php echo str_replace('http:','',BASE_URL).'newsletter/subscribe'; ?>" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="mc-embedded-subscribe-form validate" target="_blank" novalidate>
										<div class="mc-field-group left">
											...
											<input type="email" value="" name="email_confirm" style="width:0px;height:0px;">
										</div>
		...
		<?php global $secureConnection; if ($secureConnection != true):?>
		...
		<script>
		  ...
		  <?php if (!empty($amount) && !empty($tracking) && !empty($product)):?>
		  	ga('require', 'ecommerce', 'ecommerce.js');
			
			ga('ecommerce:addTransaction', {
			   'id': '<?php echo $tracking;?>',
			   'affiliation': 'CometChat',
