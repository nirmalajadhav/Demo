...
<html lang="en">
	<head>
    	...
    	<meta name="description" content="Demo the Cometchat webapp for mobile. Works seamlessly on iPhone, Androids & more! Now your users can chat from anywhere!">
	...
	<body id="iphone_demo">
		<div class="row-fluid">
			<div class="container">
				<div class="span3"></div>
				<div class="span6 iphone_case">
					<img src="<?php echo LINK_BASE_URL . "public/img/iphone_flat.png"; ?>">
					<iframe class="weburl_page" id="mobileframe" src="<?php echo BASE_URL; ?><?php echo COMETCHAT_DIR; ?>/extensions/mobilewebapp/#chat" width="291" height="404" scrolling="no" marginwidth="0" marginheight="0" frameborder="1" allowtransparency="true">
					</iframe>
				</div>
				<div class="span3 demo_right">
					...
					<div class="button">
						<a href="<?php echo SSL_LINK_BASE_URL.'buy'; ?>">Buy CometChat</a>
					</div>
				</div>
			</div>
		</div>
