...
?>
		<script>
			var couponused = <?php echo $couponused == 0 ? 'false' : 'true' ?>;
		</script>
		<?php	
			if($couponused == 0) {
		?>
			<script>
				var couponcodecase =  "<?php echo strtoupper($couponcodecase); ?>"; 
			</script>
		<?php		
			} else if($couponused == 1){
		?>
			<script>
				var couponcodecaseup = "<?php echo strtoupper($couponcodecase); ?>"; 
			</script>
<?php		
	}	
}
...
<div id="purchase">
	...
	<div class="container sect_cont">
		<div class= "row-fluid">
			<div class="span12">
				<div class="purchase_head" data-couponcode="<?php echo strtoupper($couponcodecase); ?>">
					<h2>30,000+ sites use CometChat. Get your own in 60 seconds.</h2>
				</div>
				<div class="comodo">
					<p>
			...
			<div class="row-fluid">
				<div class="span3 edition_box">
					...
					<div class="edition_price">
						<div class="row-fluid">
							<div class="span12">
								<div class="priceblock<?php if (($couponused == true) && ($couponlevel <= 1)) echo ' discounted'; ?>" style="max-width: 130px;">
									<span class="dollar">$</span>
									<span class="amt"><?php echo $basiccost; ?></span>
					...
					<div class="buy_edition">
						<div class="button">
							<a class="hidden-phone hidden-tablet hidden-desktop" href="#basic" rel="cometcontent"></a>
							<a id="buybasoptions" class="hidden-phone" href="https://www.2checkout.com/checkout/purchase?sid=138239&quantity=1&product_id=19&skip_landing=1&currency_code=USD&coupon=<?php echo strtoupper($couponcodecase); ?>">BUY NOW</a>
							<a class="visible-phone" href="https://www.2checkout.com/checkout/purchase?sid=138239&quantity=1&product_id=19&skip_landing=1&currency_code=USD&coupon=<?php echo strtoupper($couponcodecase); ?>">BUY NOW</a>
						</div>
					</div>	
				</div>
				<div class="span3 edition_box" id="big">
					...
					<div class="edition_feat">
						<a href="#" class="hastip" title="No visible links to CometChat.com and no visible mention of CometChat">Brand Free Edition</a>
					...
					<div class="edition_price">
						<div class="row-fluid">
							<div class="span12">
								<div class="priceblock<?php if (($couponused == true) && ($couponlevel <= 2)) echo ' discounted'; ?>">
									<span class="dollar">$</span>
									<span class="amt"><?php echo $procost; ?></span>
									<span class="only">only</span>
								</div>
							</div>
						</div>
					...
					<div class="buy_edition">
						<div class="button">
							...
							<a id="buyprooptions" class="hidden-phone" href="https://www.2checkout.com/checkout/purchase?sid=138239&quantity=1&product_id=20&skip_landing=1&currency_code=USD&coupon=<?php echo strtoupper($couponcodecase); ?>">BUY NOW</a>
							<a class="visible-phone" href="https://www.2checkout.com/checkout/purchase?sid=138239&quantity=1&product_id=20&skip_landing=1&currency_code=USD&coupon=<?php echo strtoupper($couponcodecase); ?>">BUY NOW</a>
						</div>
					</div>				
				</div>	
				...
				<div class="span3 edition_box">
					...
					<div class="edition_price">
						<div class="row-fluid">
							<div class="span12">
								<div class="priceblock<?php if (($couponused == true) && ($couponlevel <= 3)) echo ' discounted'; ?>">
									<span class="dollar">$</span>
									<span class="amt"><?php echo $precost; ?></span>
									<span class="only">only</span>
								</div>
							</div>
						</div>
					...
					<div class="buy_edition">
						<div class="button">
							...
							<a id="buypreoptions" class="hidden-phone" href="https://www.2checkout.com/checkout/purchase?sid=138239&quantity=1&product_id=21&skip_landing=1&currency_code=USD&coupon=<?php echo strtoupper($couponcodecase); ?>">BUY NOW</a>
							<a class="visible-phone" href="https://www.2checkout.com/checkout/purchase?sid=138239&quantity=1&product_id=21&skip_landing=1&currency_code=USD&coupon=<?php echo strtoupper($couponcodecase); ?>">BUY NOW</a>
						</div>
					</div>				
				</div>	
				<div class="span3 edition_box">
					...
					<div class="edition_feat gap">
						<a href="#" class="hastip" title="The simplest way to connect face-to-face! Leverages peer-to-peer technology to achieve high quality video conversations. No server bandwidth used and works on shared servers.">Video Conference Plugin</a>
					...
					<div class="edition_price">
						<div class="row-fluid">
							<div class="span12">
								<div class="priceblock<?php if (($couponused == true) && ($couponlevel <= 4)) echo ' discounted'; ?>">
									<span class="dollar">$</span>
									<span class="amt"><?php echo $placost; ?></span>
									<span class="only">only</span>
								</div>
							</div>
						</div>
					...
					<div class="buy_edition ">
						<div class="button">
							...
							<a id="buyplaoptions" class="hidden-phone" href="https://www.2checkout.com/checkout/purchase?sid=138239&quantity=1&product_id=28&skip_landing=1&currency_code=USD&coupon=<?php echo strtoupper($couponcodecase); ?>">BUY NOW</a>
							<a class="visible-phone" href="https://www.2checkout.com/checkout/purchase?sid=138239&quantity=1&product_id=28&skip_landing=1&currency_code=USD&coupon=<?php echo strtoupper($couponcodecase); ?>">BUY NOW</a>
						</div>
					</div>				
				</div>		
			</div>	
		...
		<div class="container">
			...
			<div class="row-fluid">
				<div class="span6 faq_cont">
					...
					<div class="answer"><p>Yes, CometChat is a one-time cost. There are no monthly or yearly costs. Only updates, support and Facebook/Gtalk chat feature require an active license.</p></div>
				</div>
				<div class="span6 faq_cont">
			...
			<div class="button coupon">
				<a class="" href="#coupon" rel="cometcontent"></a>
			</div>		
		</div>
	</div>		
</div>	
...
<div id="popup">
	<!--basic pack-->
	<div id="basic" class="hide basicplan ">
		<h3 class="head_basic">Basic Edition</h3>
		<img class="loading-image" src="<?php echo LINK_BASE_URL; ?>public/img/loading.gif">
		<div class="content">
			<div id="basic_add" class="add_ons">
				...
				<div class="addon payment row-fluid">
					<ul>
						...
						<li style="margin-left: 20px;">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option1" data-prodid="19" checked>
						...
						<li class="pads" style="margin: 0px 0 0 90px;">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option3" data-prodn="CometChat Basic Edition" data-prodid="CCBASIC">
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/paypal.png" class="buybtn" alt="paypal image"></a>
						</li>
						<?php
						/*
						<!--2 payment modes code end here-->
						
						<!--3 payment mode code starts here-->
						<!--<li>
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option1" data-prodid="19" checked>
							<a href="#" class="optionsRadios1 imgcont" ><img src="<?php echo LINK_BASE_URL; ?>public/img/visa-amex.png" class="buybtn" alt="visa-amex image"></a>
						</li>
						<li class="pads">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option2" data-prodqs="basic?tags=s,p19=49">
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/mastercard.png" class="buybtn" alt="mastercard image"></a>
						</li>
						<li>
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option3" data-prodn="CometChat Basic Edition" data-prodid="CCBE">
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/paypal.png" class="buybtn" alt="paypal image"></a>
						</li>
						<!--3 payment mode code ends here-->
						*/
						?>
					</ul>
				</div>
			...
			<div class="button proccedbtn">
				<a class="proceed" href="#" data-amt="<?php echo $basiccost; ?>">Buy Now</a>
			</div>
		</div>
	</div>
	<!--professional pack-->
		...
		<div class="content">
			<div id="prof_add" class="add_ons">
				...
				<div class="addon payment row-fluid">
					<img class="loading-image" src="<?php echo LINK_BASE_URL; ?>public/img/loading.gif">
					<ul>
						<!--2 payment mode code starts here-->
						<li style="margin-left: 20px;">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option1" data-prodid="20" checked>
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/visa-amex-mc.png" class="buybtn" alt="visa-amex-mc image"></a>
						</li>
						<li class="pads" style="margin: 0px 0 0 90px;">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option3" data-prodn="CometChat Professional Edition" data-prodid="CCPRO">
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/paypal.png" class="buybtn" alt="paypal image"></a>
						</li>
						<?php
						/*
						<!--2 payment mode code ends here-->
						...
						<li class="pads">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option2" data-prodqs="professional?tags=s,p20=129">
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/mastercard.png" class="buybtn" alt="mastercard image"></a>
						</li>
						<li>
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option3" data-prodn="CometChat Professional Edition" data-prodid="CCPRO">
			...
			<div class="button proccedbtn">
				<a class="proceed" href="#" data-amt="<?php echo $procost; ?>">Buy Now</a>
			</div>
		</div>
	</div>
	...
	<div id="premium" class="hide ">
		...
		<div class="content">
			<div id="premium_add" class="add_ons">
				...
				<div class="addon payment row-fluid">
					...
					<ul>
						<!--2 payment mode code starts here-->
						<li style="margin-left: 20px;">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option1" data-prodid="21" checked>
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/visa-amex-mc.png" class="buybtn" alt="visa-amex-mc image"></a>
						</li>
						<li class="pads" style="margin: 0px 0 0 90px;">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option3" data-prodn="CometChat Premium Edition" data-prodid="CCPRE">
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/paypal.png" class="buybtn" alt="paypal image"></a>
						</li>
						<?php
						/*
						...
						<!--3 payment modes code starts here-->
						<!--<li>
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option1" data-prodid="21" checked>
							<a href="#" class="optionsRadios imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/visa-amex.png" class="buybtn" alt="visa-amex image"></a>
						</li>
						<li class="pads">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option2" data-prodqs="premium?tags=s,p21=249">
							<a href="#" class="optionsRadios imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/mastercard.png" class="buybtn" alt="mastercard image"></a>
						</li>
						<li>
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option3" data-prodn="CometChat Premium Edition" data-prodid="CCPRE">
							<a href="#" class="optionsRadios imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/paypal.png" class="buybtn" alt="paypal image"></a>
						</li>
						<!--3 payment modes code ends here-->
						*/
						?>
					</ul>
				</div>
			...
			<div class="button proccedbtn">
				<a class="proceed" href="#" data-amt="<?php echo $precost; ?>">Buy Now</a>
			</div>
		</div>
	</div>
	<!--platinum pack-->
	<div id="platinum" class="hide ">
		...
		<div class="content">
			<div id="pla_add" class="add_ons">
				...
				<div class="addon payment row-fluid">
					...
					<ul>
						<!--2 payment mode code starts here-->
						<li style="margin-left: 20px;">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option1" data-prodid="28" checked>
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/visa-amex-mc.png" class="buybtn" alt="visa-amex-mc image"></a>
						</li>
						<li class="pads" style="margin: 0px 0 0 90px;">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option3" data-prodn="CometChat Platinum Edition" data-prodid="CCPLA">
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/paypal.png" class="buybtn" alt="paypal image"></a>
						</li>
						<?php
						/*
						...
						<li class="pads">
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option2" data-prodqs="platinum?tags=s,p28=499">
							<a href="#" class="optionsRadios1 imgcont"><img src="<?php echo LINK_BASE_URL; ?>public/img/mastercard.png" class="buybtn" alt="mastercard image"/></a>
						</li>
						<li>
							<input type="radio" name="optionsRadios" class="optionsRadios" value="option3" data-prodn="CometChat Platinum Edition" data-prodid="CCPLA">
			...
			<div class="button proccedbtn">
				<a class="proceed" href="#" data-amt="<?php echo $placost; ?>">Buy Now</a>
			</div>
		</div>
	</div>
	<!--Coupon popup-->
	<div id="coupon" class="hide">
		<h3 class="head_basic">Coupon Code</h3>
		<div class="content">
			<div id="premium_add" class="add_ons">
				<div class="row-fluid addon payment_modes">
					<div class="span12 addon_name">Enter your Coupon Code:</div>
					<?php if(isset($couponused) && ($couponused) == 0){?>
						<div class="span12 addon_name error-msg">Sorry, the coupon you have entered is either invalid or has expired.</div>
					<?php }?>
				</div>
			</div>
			<form method="post" action="<?php echo SSL_LINK_BASE_URL.'buy/coupon'; ?>">
				<div class="form discount">
					<input class="ccode" type="text" name="coupon_code" />
				</div>
				<div class="button discountbutton">
